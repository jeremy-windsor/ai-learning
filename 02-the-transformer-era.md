# Module 02 — The Transformer Era

**Mastery: 8% → 17%** · Prerequisites: Module 01

**Goal of this module:** Understand the architecture that powers *every* major LLM (GPT, Claude, Gemini, Llama, Qwen, Mistral, DeepSeek). By the end you'll be able to draw a transformer block on a napkin and explain what each piece does.

---

## Chapter 1 — Attention Is All You Need

### §2.1 — The 2017 Paper That Changed Everything
...
### §2.2 — The Core Insight: Parallelism
...
## Chapter 2 — The Full Transformer Block

### §2.8 — Anatomy of a Transformer Block
...
### §2.9 — The Feed-Forward Network (FFN)
...
### §2.10 — Residual Connections (Skip Connections)
...
### §2.13 — Encoder, Decoder, Encoder-Decoder
...
### §2.18 — GPT-3 (2020) — The "It's Real" Moment
...
### §2.20 — InstructGPT and ChatGPT (2022)
Raw GPT-3 was hard to use — you had to craft prompts cleverly. OpenAI applied **RLHF** (Module 05) to make it follow instructions. ChatGPT launched November 30, 2022, hit 100M users in 2 months, and made "LLM" a household term.

### §2.21 — GPT-4 (2023) and the Rise of Multimodality
...
## Chapter 4 — The Open-Source Transformer Family

### §2.22 — Meta's LLaMA (Feb 2023)
...
### §2.23 — Mistral and Mixture-of-Experts
...
### §2.26 — Anthropic's Claude
Closed-weight, API-only. Pioneered **Constitutional AI** (Module 05). Known for long context, strong reasoning, tool use, and the **MCP** protocol (Module 12) for connecting models to data.

### §2.27 — Google's Gemini
...
### §2.28 — The Architectural Convergence
...
### §2.29 — Grouped-Query Attention (GQA)
A small but important optimization: instead of giving every attention head its own K and V vectors, share them across groups of heads. Drastically shrinks the **KV cache** (Module 09) without hurting quality. Used in Llama 2/3, Qwen, Mistral, basically everyone.

### §2.30 — The Bitter Lesson & Checkpoint
