# Module 03 — Tokens & Embeddings

**Mastery: 17% → 25%** · Prerequisites: Module 02

**Goal of this module:** Understand exactly what an LLM "sees." It doesn't see characters or words — it sees **token IDs**, which it converts into **vectors**. By the end you'll know why "strawberry has 3 R's" trips up models, what a context window actually is, and why pricing is "per token."

---

## Chapter 1 — What Is a Token?

### §3.1 — Computers Don't Read Words
...
### §3.2 — Why Not Just Use Characters?
...
### §3.3 — Why Not Just Use Whole Words?
...
### §3.4 — Subword Tokenization: The Compromise
...
### §3.6 — WordPiece and SentencePiece
...
### §3.7 — Tiktoken and the OpenAI Tokenizers
...
### §3.8 — Let's See It: A Tokenization Example
...
### §3.9 — Why "Strawberry Has Three R's" Fails
...
### §3.10 — Tokens, Pricing, and Context Windows
...
## Chapter 2 — From Tokens to Vectors: Embeddings

### §3.11 — The Embedding Layer
...
### §3.12 — What Does an Embedding "Mean"?
...
### §3.14 — Tied vs Untied Embeddings
...
### §3.15 — Sentence/Document Embeddings (Different Beast)
...
## Chapter 3 — Position, Context, and Sequence Length

### §3.18 — Why Position Has To Be Encoded
...
### §3.19 — Sinusoidal Positional Encoding (Original Transformer)
...
### §3.23 — Context Window Length: 2k → 1M+
...
The growth is enabled by RoPE/ALiBi + memory tricks (Module 09: FlashAttention, paged KV cache). Note: practical quality often degrades well before the advertised maximum — "lost in the middle" is real (§12.15).

### §3.24 — Why Long Context Is Hard: Attention Is O(n²)
...
## Chapter 4 — Inference Mechanics: How Generation Actually Works

### §3.25 — Autoregressive Generation
...
### §3.28 — Why "Temperature 0" Is Not Truly Deterministic
...
### §3.29 — Stop Sequences and Special Tokens
Models have special tokens like `<|im_start|>`, `<|im_end|>`, `<|eot_id|>` that delimit messages, system prompts, tool calls. The **chat template** (§5.2) defines how messages get serialized into tokens. Get this wrong and the model behaves badly.
...
### §3.30 — Checkpoint — Explain it Back
**Quiz yourself:**
...
You now understand what the model *sees* and how it produces output. Next module: how it learned in the first place.
