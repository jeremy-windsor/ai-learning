# Module 05 — Fine-Tuning & Alignment

**Mastery: 33% → 42%** · Prerequisites: Module 04

**Goal of this module:** Understand how a raw base model becomes ChatGPT, Claude, or `qwen3:8b-instruct`. By the end you'll know what SFT, RLHF, DPO, LoRA, and QLoRA mean — and which one *you* would use to customize a model for your team.

---

## Chapter 1 — From Base Model to Assistant

### §5.1 — Why a Base Model Isn't an Assistant
...
## Chapter 2 — RLHF and Its Successors

### §5.6 — Reinforcement Learning from Human Feedback (RLHF)
...
### §5.10 — Constitutional AI (Anthropic)
...
### §5.11 — RLAIF (RL from AI Feedback)
...
### §5.12 — Reasoning Models: RL on Chain-of-Thought
...
### §5.13 — The Problem with Full Fine-Tuning
...
### §5.14 — LoRA (Low-Rank Adaptation, 2021)
...
## Chapter 4 — Doing It Yourself

### §5.19 — When You Should Fine-Tune (and When You Shouldn't)
...
### §5.20 — RAG vs Fine-Tuning vs Both
...
### §5.22 — Evaluation: The Hardest Part
...
### §5.24 — Safety Tuning and Jailbreaks
...
### §5.25 — The Full Pipeline, End-to-End
1. **Pretraining** (Module 04) → base model
...
6. **Quantization** (Module 07) → deployable model
7. **Inference engine** (Module 08) → serving

### §5.26 — Why "Open-Weight" Doesn't Mean "Open-Source"
...
### §5.30 — Checkpoint — Explain it Back
**Quiz yourself:**
...
You now understand how models are made and shaped. The rest of the curriculum is about **how we run them**.
