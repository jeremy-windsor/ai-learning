# Module 10 — Distributed Training

**Mastery: 75% → 83%** · Prerequisites: Modules 04, 06

**Goal of this module:** Understand how a 70B–600B model is trained across thousands of GPUs without falling over. By the end you'll be able to explain DDP, FSDP, ZeRO stages, tensor parallelism, pipeline parallelism, and **3D parallelism** — the recipe behind every frontier model.

---

## Chapter 1 — Why Distribute?

### §10.1 — The Two Reasons We Distribute Training
...
### §10.2 — The Memory Anatomy of Training
...
### §10.3 — Collective Communication 101
...
### §10.4 — Latency vs Bandwidth in Collectives
...
## Chapter 2 — Data Parallelism (DDP)

### §10.5 — Distributed Data Parallel (DDP) — The Easy Mode
...
### §10.8 — Gradient Checkpointing (Activation Recomputation)
...
## Chapter 3 — ZeRO and FSDP

### §10.9 — The Insight Behind ZeRO
...
### §10.10 — ZeRO Stage 1: Shard Optimizer States
...
### §10.11 — ZeRO Stage 2: + Shard Gradients
...
### §10.12 — ZeRO Stage 3: + Shard Weights
...
### §10.13 — FSDP: PyTorch's Native ZeRO-3
...
### §10.14 — Activation Sharding (FSDP+TP, ZeRO-Infinity)
...
## Chapter 4 — Model Parallelism: TP and PP

### §10.15 — When Data Parallelism Isn't Enough
...
### §10.16 — Tensor Parallelism (TP): Split Within a Layer
...
### §10.17 — Pipeline Parallelism (PP): Split Between Layers
...
### §10.18 — Expert Parallelism (EP) for MoE
...
### §10.20 — Context Parallelism / Ring Attention
...
## Chapter 5 — 3D Parallelism and the Real World

### §10.21 — Combining All Three: 3D Parallelism
...
### §10.24 — NeMo, Axolotl, Colossal-AI, LLaMA-Factory
...
### §10.25 — How a Frontier Training Run Actually Looks
- 10,000–100,000 GPUs
- Months of compute
...
### §10.26 — The Engineering of Reliability
...
### §10.27 — Distillation as a Training Strategy
Once you have a giant trained model, you can train smaller models to mimic it (§5.28). Distillation is now a major part of the pipeline — Llama-3.2 small models, Qwen-2.5 small models, gpt-4o-mini and many others are fundamentally distilled.

### §10.28 — RLHF Training Infrastructure
...
### §10.29 — Continuous / Online Training
...
### §10.30 — Checkpoint — Explain it Back
**Quiz yourself:**
