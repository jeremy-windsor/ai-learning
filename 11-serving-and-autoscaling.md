# Module 11 — Serving & Autoscaling

**Mastery: 83% → 92%** · Prerequisites: Modules 08–09

**Goal of this module:** Take a working inference engine and turn it into a reliable, scalable, multi-tenant production service. By the end you'll understand how to architect a system that serves millions of LLM requests without melting down or blowing the budget.

---

## Chapter 1 — From Engine to Service

### §11.1 — Engine vs Service
...
### §11.2 — The OpenAI-Compatible API Layer
...
### §11.3 — NVIDIA Triton Inference Server (the server, not the language)
...
### §11.4 — BentoML, Ray Serve, KServe, Modal
...
### §11.5 — Choosing Your Serving Architecture
...
## Chapter 2 — Latency, Throughput, and SLOs

### §11.6 — The Two Numbers Everyone Cares About
...
### §11.7 — Define Your SLOs Up Front
...
### §11.10 — Tail Latency Is the Real Enemy
...
### §11.11 — Horizontal vs Vertical Scaling
...
### §11.12 — Load Balancing Considerations
...
### §11.15 — Multi-Region, Multi-Cloud
...
### §11.16 — Disaggregated Serving in Production (§8.24 revisited)
...
## Chapter 4 — Multi-Tenancy, Cost, Observability

### §11.17 — Multi-Model on One GPU
...
### §11.18 — Token Accounting and Quotas
...
### §11.19 — Prompt Caching for Cost
OpenAI, Anthropic, Google all offer prompt caching at the API layer — 50–90% discount on cached tokens. Underlying mechanism: prefix sharing in their inference engines (§9.6). Architect prompts so the long, stable parts come *first* (system prompt, tool defs, RAG context).
...
### §11.21 — Observability: What to Log
...
### §11.23 — Content Filtering and Safety in Production
Two layers usually:
...
### §11.24 — Retries, Timeouts, Idempotency
...
## Chapter 5 — Patterns and the Real World

### §11.26 — The Modern LLM App Architecture
```
...
### §11.27 — Compound Systems Are the Norm
...
### §11.30 — Checkpoint — Explain it Back
**Quiz yourself:**
...
You can now design real systems. Last module: the ecosystem and what's coming.
