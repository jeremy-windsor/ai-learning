# Module 12 — Ecosystem & Future

**Mastery: 92% → 100%** · Prerequisites: everything before it

**Goal of this module:** Tie everything together. By the end you'll be able to explain — confidently, in one breath — how Ollama, OpenAI, Qwen, Claude, RAG systems, and AI agents all actually work, and where the field is going next.

---

## Chapter 1 — The Closed-Frontier Players

### §12.1 — OpenAI: Stack Overview
...
## Chapter 2 — The Open-Weight Ecosystem

### §12.6 — Qwen (Alibaba)
- Strong family across sizes (0.6B → 235B MoE in Qwen3; up to 397B MoE in Qwen3.5)
...
- Frequent releases — Qwen3 (April 2025) → Qwen3.5 family (Feb 2026, native multimodal, 256k+ context) → **Qwen3.6-27B / Qwen3.6-Plus** (April 2026, dense 27B beating 397B MoE on agentic coding, up to 1M context)
- **Qwen3-Coder-480B-A35B** is the current go-to open-weight coding model
...
- **DeepSeek-R1** (Jan 2025) — first open reasoning model competitive with o1; **R1-0528** (May 2025) refined reasoning traceability
- **DeepSeek-V4** (preview April 2026) — Flash (284B) and Pro (1.6T) variants, up to 1M context, "closes the gap" with frontier closed models
...
### §12.9 — Other Notable Open Players
...
### §12.11 — Local Inference Tools Recap
...
## Chapter 3 — RAG, Agents, and Compound Systems

### §12.12 — Retrieval-Augmented Generation (RAG)
...
### §12.14 — Why Naïve RAG Often Disappoints
...
### §12.16 — Tool Use / Function Calling
...
### §12.18 — MCP (Model Context Protocol)
...
### §12.19 — LangChain, LlamaIndex, DSPy, LangGraph, Pydantic AI
...
### §12.20 — Reasoning Models: The 2024–2025 Inflection
**OpenAI o1/o3, DeepSeek-R1, Qwen QwQ, Gemini Thinking, Claude with extended thinking**. Models trained via RL to produce long internal chain-of-thought before answering. Massive gains on math, code, science. Cost and latency tradeoff: 10–100× more output tokens per answer. Reshaped the field — and how we serve (§11.7).

### §12.21 — Multimodal Convergence
...
### §12.23 — World Models and Embodied AI
...
### §12.25 — Continual / Online Learning
...
### §12.27 — Scaling Laws Are Bending, Not Breaking
...
### §12.28 — The Open vs Closed Race
By 2026, the gap between top open-weight models (Llama 4, Qwen3.5/3.6, DeepSeek-V3/R1/V4-preview) and frontier closed models (GPT-5, Claude, Gemini) is small for most tasks — sometimes nonexistent. OpenAI itself acknowledged the shift by releasing **gpt-oss** open-weight models alongside GPT-5. Closed players still hold edges in: bleeding-edge multimodal, frontier reasoning, scale of training, distribution. Whether the gap persists is *the* question of the next two years.

### §12.29 — Geopolitics of AI
...
### §12.30 — Energy and Sustainability
...
### §12.32 — Practice Explanations: "How Does Ollama Work?"
...
### §12.33 — Practice Explanations: "How Does OpenAI Work?"
...
### §12.34 — Practice Explanations: "What Even Is an LLM, in 30 Seconds?"
...
### §12.35 — Final Recap
You now understand:
- The 70-year arc from symbolic AI to deep learning to LLMs (Modules 01–02)
- How models see and produce text (Module 03)
- How models are trained, fine-tuned, and aligned (Modules 04–05)
- The hardware and number formats they run on (Modules 06–07)
- The engines that serve them and the optimizations that make them fast (Modules 08–09)
- How frontier training scales across thousands of GPUs (Module 10)
- How real production services are built around all of this (Module 11)
- Who the players are and where the field is going (Module 12)
